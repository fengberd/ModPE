...
{
	writeText("/sdcard/games/com.mojang/minecraftWorlds/"+Level.getWorldDir()+"/supercheat/datas/"+name+".supercheat_dat",Data);
}
function load(name)//读取数据
{
	try
	{
		var vdir = new java.io.File("/sdcard/games/com.mojang/minecraftWorlds/"+Level.getWorldDir()+"/supercheat/datas/")
		if(!vdir.exists())
		{
			vdir.mkdirs();
			return "";
		}
		var vfile = new java.io.File("/sdcard/games/com.mojang/minecraftWorlds/"+Level.getWorldDir()+"/supercheat/datas/"+name+".supercheat_dat");
		if(vfile.exists())
		{
			var reader = new java.io.BufferedReader(new java.io.FileReader(vfile),8192);
...
{
	writeText("/sdcard/games/com.mojang/minecraftpe/supercheat/datas/"+name+".supercheat_dat",Data);
}
function load2(name)//读取数据(全局)
{
	try
	{
		var vdir = new java.io.File("/sdcard/games/com.mojang/minecraftpe/supercheat/datas/")
		if(!vdir.exists())
		{
			vdir.mkdirs();
			return "";
		}
		var vfile = new java.io.File("/sdcard/games/com.mojang/minecraftpe/supercheat/datas/"+name+".supercheat_dat");
		if(vfile.exists())
		{
			var reader = new java.io.BufferedReader(new java.io.FileReader(vfile),8192);
			var ttext=reader.readLine();
