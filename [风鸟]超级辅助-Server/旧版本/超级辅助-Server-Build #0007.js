...
function switchData(data)//GUI判断指令
{
	...
	case"MOREMENU":
		Menus_MoreMenu=new Array(
			...
			{kind:"text",text:"by 风鸟",color:"",size:16},
			{kind:"text",text:build,color:android.graphics.Color.GREEN,size:16},
			{kind:"check",text:"飞行模式",data:"fly",torf:Player.canFly(),color:android.graphics.Color.RED},
	...
	try{
		...
		for(var i=0;i<MenuData.length;i++)
		{
			...
			case"233System":
				...
				TextE.setHint("请输入要刷的内容");
				TextE.setText(spdata);
				layout.addView(TextE);
				Menu_addText(layout,textParams,"刷屏速度:","",18);
